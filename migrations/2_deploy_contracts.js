...
module.exports = async function (deployer) {
  ...
  await fesbtoken.approve(matejswap.address, '100000000000000000000000')
  await matejswap.provideLiquidity('100000000000000000000000', {value: '10000000000000000000'})
